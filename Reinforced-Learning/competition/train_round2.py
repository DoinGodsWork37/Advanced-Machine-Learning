...
n_steps = 400_000 # number of times
...
replay_memory_maxlen = 10_000_000 #atleast training interval * number of steps
...
def train_dqn_net():
    ...
    online_network = load_model("pacman1.h5")
    ...
    while step < n_steps:
        ...
        if iteration >= warmup and iteration % training_interval == 0:
            ...
            if step % copy_steps == 0:
                target_network.set_weights(online_network.get_weights())
    online_network.save("pacman2.h5")
